...
## [0.1.17](https://github.com/ImmuneFOMO/fetchira/compare/v0.1.16...v0.1.17) - 2026-09-17

### Added

- update demo video

## [0.1.16](https://github.com/ImmuneFOMO/fetchira/compare/v0.1.15...v0.1.16) - 2026-09-15

### Added

- add graceful and force updates for local and hosted Fetchira
...
- *(chatgpt)* harden browser integration and image editing

### Other

- document cargo install and Linux install paths
